                         ...
                         struct binding_ctx_out *b_ctx_out)
{
    ...
    if (is_mirror) {
        container_b_lport = local_binding_add_lport(binding_lports, parent_lbinding, pb,
                                                    LP_MIRROR);
    } else {
        container_b_lport = local_binding_add_lport(binding_lports, parent_lbinding, pb,
                                                    LP_CONTAINER);
                         ...
                         struct binding_ctx_out *b_ctx_out)
{
    ...
    /* If its a container or mirror lport, then delete its entry
     * from local_lport if present.
 ...
 *
 * If the 'b_lport' type is LP_CONTAINER/LP_MIRROR, then its parent_port
