...
#define OFTABLE_OUTPUT_LARGE_PKT_DETECT  43
#define OFTABLE_OUTPUT_LARGE_PKT_PROCESS 44
#define OFTABLE_REMOTE_OUTPUT            45
#define OFTABLE_REMOTE_VTEP_OUTPUT       46
#define OFTABLE_LOCAL_OUTPUT             47
#define OFTABLE_CHECK_LOOPBACK           48

/* Start of the OUTPUT section of the pipeline. */
#define OFTABLE_OUTPUT_INIT OFTABLE_OUTPUT_LARGE_PKT_DETECT

/* Start of LOG_PIPELINE_LEN tables. */
#define OFTABLE_LOG_EGRESS_PIPELINE      49
