                     ...
                     bool ls_dp)
{
    ...
    if (lb_vip_nb->lb_health_check || lb->is_distributed) {
        ...
        /* If all the health-checked backends are offline and "fail-open" is
        ...
        if (!n_active_backends && lb_vip_nb->lb_health_check
            && smap_get_bool(&lb_vip_nb->lb_health_check->options,
                             "fail-open", false)) {
