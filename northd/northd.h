...
struct northd_input {
    ...
    const struct sbrec_mirror_rule_table *sbrec_mirror_rule_table;
...
#define PIPELINE_STAGES                                                   \
    ...
    PIPELINE_STAGE(SWITCH, OUT, MIRROR,       0, "ls_out_mirror")        \
    PIPELINE_STAGE(SWITCH, OUT, PRE_ACL,      1, "ls_out_pre_acl")        \
    PIPELINE_STAGE(SWITCH, OUT, PRE_LB,       2, "ls_out_pre_lb")         \
    PIPELINE_STAGE(SWITCH, OUT, PRE_STATEFUL, 3, "ls_out_pre_stateful")   \
    PIPELINE_STAGE(SWITCH, OUT, ACL_HINT,     4, "ls_out_acl_hint")       \
    PIPELINE_STAGE(SWITCH, OUT, ACL_EVAL,     5, "ls_out_acl_eval")       \
    PIPELINE_STAGE(SWITCH, OUT, ACL_SAMPLE,   6, "ls_out_acl_sample")     \
    PIPELINE_STAGE(SWITCH, OUT, ACL_ACTION,   7, "ls_out_acl_action")     \
...
struct ovn_port {
    ...
    struct ovn_port *mr_port;
    const char *mr_parent_port;
